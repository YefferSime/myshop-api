...
class bannerController {
    add_banner = async (req, res) => {
        ...
        form.parse(req, async (err, field, files) => {
            ...
            try {
                ...
                responseReturn(res, 201, { banner, message: "¡Banner añadido con éxito!" });
            } catch (error) {
                console.log(error);
    ...
    // Método para actualizar un banner existente, reemplazando la imagen en la nube.
    // Aquí demuestro la importancia de la gestión eficiente de recursos.
    update_banner = async (req, res) => {
        ...
        form.parse(req, async (err, _, files) => {
            ...
            try {
                ...
                responseReturn(res, 200, { banner, message: "¡Banner actualizado con éxito!" });
